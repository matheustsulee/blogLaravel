...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "Repita o mesmo valor novamente.",
		accept: "Digite um valor com uma extensão válida.",
		maxlength: $.validator.format("Não digite mais que {0} caracteres."),
		minlength: $.validator.format("Digite pelo menos {0} caracteres."),
		rangelength: $.validator.format("Digite um valor entre {0} e {1}."),
